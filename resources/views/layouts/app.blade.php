...
<body>
    ...
    <div id="app">
        <nav  class="navbar navbar-expand-md navbar-light bg-lime shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="#">
                    Sistem Informasi Kas Warga
                </a>
                <input type="submit"  class="btn btn-warning btn-sm" value="Refresh Page" onClick="document.location.reload(true)">
